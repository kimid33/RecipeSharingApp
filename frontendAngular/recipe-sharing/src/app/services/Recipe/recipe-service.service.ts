...
export class RecipeServiceService {
  ...
  getRecipes():Observable<any>{
    ...
    return this.http.get(`${this.baseUrl}/api/recipies/api/all`,{headers}).pipe(
      tap((recipes)=>{
    ...
    const headers = this.getHeaders();
    return this.http.post(`${this.baseUrl}/api/recipies`,recipe, {headers}).pipe(
      tap((newRecipe)=>{
        const currentState=this.recipeSubject.value;
  ...
  updateRecipes(recipe:any):Observable<any>{
    const headers = this.getHeaders();
    return this.http.put(`${this.baseUrl}/api/recipies/${recipe.id}`,recipe,{headers}).pipe(
  ...
  likeRecipes(id:any):Observable<any>{
    const headers = this.getHeaders();
    return this.http.put(`${this.baseUrl}/api/recipies/${id}/like`,{headers}).pipe(
      tap((updatedRecipe:any)=>{
        const currentState=this.recipeSubject.value;
        const updatedRecipes=currentState.recipes.map
        ((item:any)=>item.id===updatedRecipe.id?updatedRecipe:item)
  ...
  deleteRecipes(id:any):Observable<any>{
    const headers = this.getHeaders();
    return this.http.delete(`${this.baseUrl}/api/recipies/${id}`,{headers}).pipe(
